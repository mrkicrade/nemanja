...
<?php 
  if (!isset($_SESSION['id'])) { // ! predstavlja negaciju. Mi sada pitamo "ako ne postoji SESSION['id']", ato znači ako korisnik nije ulogovan...
  ...
  <div class="row">
    <div class="col-6 offset-3">
      ...
      <form action="new.add.php" method="post">
        ...
        <button type="submit" class="btn btn-primary form-control mt-4">Add new</button>
      </form>
    </div>
  </div>
</div>
